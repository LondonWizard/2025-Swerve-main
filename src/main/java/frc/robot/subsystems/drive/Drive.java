...
public class Drive extends SubsystemBase {
  ...
  private final LimeLightCam limelight_a = new LimeLightCam("limelight-a");
  private final LimeLightCam limelight_b = new LimeLightCam("limelight-b");
  ...
  public boolean shouldRejectPose(AprilTagResult latestResult) {
    if (Units.radiansToDegrees(gyroInputs.yawVelocityRadPerSec) >= 720) {
      ...
      return true;
        ...
        || latestResult.distToTag > kMaxTagDistance) {
      return true;
    } else {
      return false;
    }
